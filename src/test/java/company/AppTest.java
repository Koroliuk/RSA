...
public class AppTest {
    ...
    public void qCommand() throws IOException {
        Assert.assertEquals(App.executeCommand("q"), "Bye!");
    }
    ...
    public void hCommand() throws IOException {
        ...
        Assert.assertEquals(App.executeCommand("h"), helpString);
    }
    ...
    public void gCommandWithDefaultPrimes() throws IOException {
        ...
        Assert.assertEquals(App.executeCommand("G"), expectedResult);
    }
    ...
    public void gCommandWithUserPrimes() throws IOException {
        ...
        Assert.assertEquals(App.executeCommand("g 4079 3701"), expectedResult);
    }

    @Test
    public void eCommand() throws IOException {
        Assert.assertEquals(App.executeCommand("e 65537 9173503 test1.txt test2.txt"), "Done");
    }

    @Test
    public void dCommand() throws IOException {
        Assert.assertEquals(App.executeCommand("d 4922825 9173503 test2.txt test3.txt"), "Done");
    }
}